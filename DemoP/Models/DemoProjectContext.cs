...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-VTBLP8D;Database=DemoProject;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cart>(entity =>
            {
                ...
                entity.HasOne(d => d.Customer)
                    ...
                    .HasConstraintName("FK__CART__CustomerID__76969D2E");
                ...
                entity.HasOne(d => d.ProductVariation)
                    ...
                    .HasConstraintName("FK__CART__ProductVar__787EE5A0");
            });
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                entity.HasKey(e => e.CustomerContact)
                    .HasName("PK__Customer__BB5D178503A3368C");
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__Customer__UserID__73BA3083");
            });
            ...
            modelBuilder.Entity<OrderStatus>(entity =>
            {
                ...
                entity.HasOne(d => d.OrderProduct)
                    ...
                    .HasConstraintName("FK__OrderStat__Order__7B5B524B");
            });

            modelBuilder.Entity<OrderTable>(entity =>
            {
                entity.HasKey(e => e.OrderId)
                    .HasName("PK__OrderTab__C3905BCFCA75FD46");
                ...
                entity.HasOne(d => d.Product)
                    .WithMany(p => p.OrderTable)
                    .HasForeignKey(d => d.ProductId)
                    .HasConstraintName("FK__OrderTabl__Produ__7C4F7684");

                entity.HasOne(d => d.ProductVariation)
                    .WithMany(p => p.OrderTable)
                    .HasForeignKey(d => d.ProductVariationId)
                    .HasConstraintName("FK__OrderTabl__Produ__7D439ABD");
            });
            ...
            modelBuilder.Entity<RoleTable>(entity =>
            {
                entity.HasKey(e => e.RoleId)
                    .HasName("PK__RoleTabl__8AFACE3A5B9DA2F4");
            ...
            modelBuilder.Entity<Seller>(entity =>
            {
                entity.HasKey(e => e.CompanyContact)
                    .HasName("PK__Seller__0713D0CDDE590A13");
                ...
                entity.HasOne(d => d.SellerNavigation)
                    .WithMany(p => p.Seller)
                    .HasForeignKey(d => d.Sellerid)
                    .HasConstraintName("FK__Seller__Sellerid__70DDC3D8");
            });
